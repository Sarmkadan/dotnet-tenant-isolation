...
/// <summary>
/// Unit tests for <see cref="TenantService"/> class.
/// Tests all tenant operations including creation, retrieval, activation, suspension, deletion, updates, and statistics.
/// </summary>
public class TenantServiceTests
{
	/// <summary>
	/// Mock repository for testing tenant data operations.
	/// </summary>
	internal readonly Mock<TenantRepository> _mockTenantRepository;

	/// <summary>
	/// Mock dynamic tenant store for testing tenant resolution.
	/// </summary>
	...
	/// <summary>
	/// System under test - the TenantService instance being tested.
	/// </summary>
	internal readonly TenantService _sut;

	/// <summary>
	/// Initializes a new instance of the <see cref="TenantServiceTests"/> class.
	/// Sets up mocks for tenant repository, dynamic tenant store, and logger.
	/// </summary>
	...
	[Fact]
	/// <summary>
	/// Tests that creating a tenant with valid input successfully creates and returns a tenant.
	/// Verifies that the tenant is properly initialized with correct properties and default values.
	/// </summary>
	...
	[Fact]
	/// <summary>
	/// Tests that creating a tenant with a custom isolation strategy uses the provided strategy.
	/// Verifies that the IsolationStrategy property is correctly set from the parameter.
	/// </summary>
	...
	[InlineData(" ")]
	/// <summary>
	/// Tests that creating a tenant with null, empty, or whitespace name throws ArgumentException.
	/// Verifies that the name parameter is validated and the correct parameter name is reported.
	/// </summary>
	...
	[InlineData(" ")]
	/// <summary>
	/// Tests that creating a tenant with null, empty, or whitespace slug throws ArgumentException.
	/// Verifies that the slug parameter is validated and the correct parameter name is reported.
	/// </summary>
	...
	[InlineData("")]
	/// <summary>
	/// Tests that creating a tenant with null or empty email throws ArgumentNullException.
	/// Verifies that the adminEmail parameter is validated and the correct parameter name is reported.
	/// </summary>
	...
	[Fact]
	/// <summary>
	/// Tests that creating a tenant with a duplicate slug throws TenantIsolationException.
	/// Verifies that slug uniqueness is checked and appropriate error message is returned.
	/// </summary>
	...
	[Fact]
	/// <summary>
	/// Tests that repository exceptions are wrapped in TenantIsolationException when creating a tenant.
	/// Verifies proper exception handling and error message formatting.
	/// </summary>
	...
	[Fact]
	/// <summary>
	/// Tests that mixed-case slugs are converted to lowercase when creating a tenant.
	/// Verifies that slug normalization is applied correctly.
	/// </summary>
	...
	[Fact]
	/// <summary>
	/// Tests that retrieving a tenant by valid ID returns the correct tenant.
	/// Verifies that the dynamic tenant store is called and the tenant is returned.
	/// </summary>
	...
	[Fact]
	/// <summary>
	/// Tests that retrieving a tenant by non-existent ID throws TenantNotResolvedException.
	/// Verifies that null tenant results are properly handled and appropriate exception is thrown.
	/// </summary>
	...
	[Fact]
	/// <summary>
	/// Tests that retrieving a tenant by valid slug returns the correct tenant.
	/// Verifies that tenant lookup by slug works correctly.
	/// </summary>
	...
	[Fact]
	/// <summary>
	/// Tests that retrieving a tenant by slug is case-insensitive.
	/// Verifies that slug matching is case-insensitive.
	/// </summary>
	...
	[InlineData(" ")]
	/// <summary>
	/// Tests that retrieving a tenant with null, empty, or whitespace slug throws ArgumentException.
	/// Verifies that slug parameter is validated.
	/// </summary>
	...
	[Fact]
	/// <summary>
	/// Tests that retrieving a tenant by non-existent slug throws TenantNotResolvedException.
	/// Verifies that appropriate exception is thrown when tenant is not found.
	/// </summary>
	...
	[Fact]
	/// <summary>
	/// Tests that activating an active tenant returns true and calls repository.
	/// Verifies that tenant activation works for valid active tenants.
	/// </summary>
	...
	[Fact]
	/// <summary>
	/// Tests that activating a deleted tenant throws TenantNotActiveException.
	/// Verifies that deleted tenants cannot be activated.
	/// </summary>
	...
	[Fact]
	/// <summary>
	/// Tests that activating a tenant with archived status throws TenantNotActiveException.
	/// Verifies that archived tenants cannot be activated.
	/// </summary>
	...
	[Fact]
	/// <summary>
	/// Tests that suspending a valid tenant returns true and calls repository.
	/// Verifies that tenant suspension works with default null reason.
	/// </summary>
	...
	[Fact]
	/// <summary>
	/// Tests that suspending a tenant with a reason passes the reason to repository.
	/// Verifies that suspension reason is properly passed through to the repository.
	/// </summary>
	...
	[Fact]
	/// <summary>
	/// Tests that deleting a valid tenant marks it as deleted and archives it.
	/// Verifies that tenant deletion updates IsDeleted flag and Status to Archived.
	/// </summary>
	...
	[Fact]
	/// <summary>
	/// Tests that updating a tenant with a valid action updates and returns the tenant.
	/// Verifies that tenant update modifies properties and updates UpdatedAt timestamp.
	/// </summary>
	...
	[Fact]
	/// <summary>
	/// Tests that updating a tenant with null action throws ArgumentNullException.
	/// Verifies that updateAction parameter is validated.
	/// </summary>
	...
	[Fact]
	/// <summary>
	/// Tests that a valid subscription returns true.
	/// Verifies that subscription validation checks for future expiration date.
	/// </summary>
	...
	[Fact]
	/// <summary>
	/// Tests that an expired subscription returns false.
	/// Verifies that subscription validation checks for past expiration date.
	/// </summary>
	...
	[Fact]
	/// <summary>
	/// Tests that getting active tenants returns a list of active tenants.
	/// Verifies that the dynamic tenant store returns all active tenants.
	/// </summary>
	...
	[Fact]
	/// <summary>
	/// Tests that getting active tenants with no active tenants returns empty list.
	/// Verifies that empty tenant list is handled correctly.
	/// </summary>
	...
	[Fact]
	/// <summary>
	/// Tests that getting expiring subscriptions with default days calls repository with 30 days.
	/// Verifies that default 30-day window is used when no parameter is provided.
	/// </summary>
	...
	[Fact]
	/// <summary>
	/// Tests that getting expiring subscriptions with custom days calls repository with custom days.
	/// Verifies that custom day window is properly passed to repository.
	/// </summary>
	...
	[Fact]
	/// <summary>
	/// Tests that searching tenants with a query matching name returns matching tenant.
	/// Verifies that tenant search matches against tenant name.
	/// </summary>
	...
	[Fact]
	/// <summary>
	/// Tests that searching tenants with a query matching slug returns matching tenant.
	/// Verifies that tenant search matches against tenant slug.
	/// </summary>
	...
	[Fact]
	/// <summary>
	/// Tests that searching tenants with a query matching email returns matching tenant.
	/// Verifies that tenant search matches against tenant admin email.
	/// </summary>
	...
	[InlineData(" ")]
	/// <summary>
	/// Tests that searching tenants with null, empty, or whitespace query returns empty list.
	/// Verifies that query parameter is validated.
	/// </summary>
	...
	[Fact]
	/// <summary>
	/// Tests that searching tenants with no matches returns empty list.
	/// Verifies that non-matching queries return empty results.
	/// </summary>
	...
	[Fact]
	/// <summary>
	/// Tests that a tenant with trial status returns true.
	/// Verifies that trial status is correctly identified.
	/// </summary>
	...
	[Fact]
	/// <summary>
	/// Tests that a tenant with active status returns false.
	/// Verifies that active status is not considered trial.
	/// </summary>
	...
	[Fact]
	/// <summary>
	/// Tests that getting tenant statistics returns statistics with tenant counts.
	/// Verifies that statistics include total tenants, active tenants, and expiring subscriptions.
	/// </summary>
	...
	[Fact]
	/// <summary>
	/// Tests that getting tenant statistics with no tenants returns zero statistics.
	/// Verifies that empty tenant data is handled correctly.
	/// </summary>
	...
	[Fact]
	/// <summary>
	/// Tests that getting tenants by valid status returns tenants with that status.
	/// Verifies that tenant filtering by status works correctly.
	/// </summary>
	...
	[Fact]
	/// <summary>
	/// Tests that getting tenants by status with no matching status returns empty list.
	/// Verifies that non-matching status queries return empty results.
	/// </summary>

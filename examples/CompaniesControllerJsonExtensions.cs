...
/// <summary>
/// Provides System.Text.Json serialization and deserialization extensions for <see cref="CompaniesController"/>.
/// </summary>
public static class CompaniesControllerJsonExtensions
{
    ...
    /// <summary>
    /// Serializes the <see cref="CompaniesController"/> instance to a JSON string.
    /// </summary>
    ...
    /// <summary>
    /// Deserializes a JSON string into a <see cref="CompaniesController"/> instance.
    /// </summary>
    /// <param name="json">The JSON string to deserialize.</param>
    /// <returns>A <see cref="CompaniesController"/> instance populated from the JSON data.</returns>
    ...
    /// <summary>
    /// Attempts to deserialize a JSON string into a <see cref="CompaniesController"/> instance.
    /// </summary>
    /// <param name="json">The JSON string to deserialize.</param>
    /// <param name="value">Receives the deserialized <see cref="CompaniesController"/> instance if successful.</param>
